...
INSTALLED_APPS = [
    ...
    # Local apps, referenced via djtut2.appname
    'djtut2.polls',
]
...
#AUTH_PROFILE_MODULE = 'djtut2.accounts.UserProfile'
...
WSGI_APPLICATION = 'djtut2.wsgi.application'
