"""
Starter fabfile for deploying the djtut2 project.
...
# CHANGEME
env.hosts = ['user@djtut2.example.com']
env.code_dir = '/srv/www/djtut2'
env.project_dir = '/srv/www/djtut2/djtut2'
env.static_root = '/srv/www/djtut2/static/'
env.virtualenv = '/srv/www/djtut2/.virtualenv'
env.code_repo = 'git@github.com:user/djtut2.git'
